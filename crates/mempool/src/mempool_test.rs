...
macro_rules! add_tx_input {
    // Pattern for tip, tx_hash, sender_address, tx_nonce, and account_nonce.
    ...
    // Pattern for tx_hash, sender_address, tx_nonce, and account_nonce.
