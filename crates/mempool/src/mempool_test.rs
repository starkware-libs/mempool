...
fn test_get_txs(#[case] requested_txs: usize) {
    let tx_tip_20 = add_tx_input!(tip: 20, tx_hash: 1).tx;
    let tx_tip_30 = add_tx_input!(tip: 30, tx_hash: 2, sender_address: "0x1").tx;
    let tx_tip_10 = add_tx_input!(tip: 10, tx_hash: 3, sender_address: "0x2").tx;

    let mut txs = vec![tx_tip_20, tx_tip_30, tx_tip_10];
