...
#[fixture]
// TODO(Mohammad): Figure out another way to keep te channel open.
fn gateway() -> (Gateway, tokio::sync::mpsc::Receiver<GatewayToMempoolMessage>) {
...
async fn test_routes(
    ...
    gateway: (Gateway, tokio::sync::mpsc::Receiver<GatewayToMempoolMessage>),
) {
...
async fn test_is_alive(gateway: (Gateway, tokio::sync::mpsc::Receiver<GatewayToMempoolMessage>)) {
