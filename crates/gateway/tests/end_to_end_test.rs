...
use starknet_mempool_types::mempool_types::{
    Account, AccountState, BatcherToMempoolMessage, GatewayNetworkComponent,
...
// fn initialize_batcher_network_channels()
// -> (BatcherMempoolNetworkComponent, MempoolBatcherNetworkComponent) {
...
//         MempoolBatcherNetworkComponent::new(tx_mempool_to_batcher, rx_batcher_to_mempool),
//     )
// }
...
async fn test_end_to_end() {
    ...
    // let (
    //     batcher_to_mempool_network,
    //     mempool_to_batcher_network,
    // ) = initialize_batcher_network_channels();
    ...
    // Initialize Mempool.
    let mut mempool =
        Mempool::empty(mempool_to_gateway_network, rx_batcher_to_mempool, tx_mempool_to_batcher);
    ...
    // TODO(Mohammad): uncomment the code once Batcher channels are supported.
    let batcher_to_mempool_message = BatcherToMempoolMessage::GetTxs(2);
    ...
    print!("MoNas EOT: {:?}", mempool_message);
