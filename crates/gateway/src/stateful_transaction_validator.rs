...
impl<S: StateReader> StatefulTransactionValidator<S> {
    ...
    pub fn new(
        ...
        // TODO(yael 16/4/24): consider maintaining a global cache instead of cache per transaction.
        let global_contract_cache = GlobalContractCache::new(config.global_contract_cache_size);
