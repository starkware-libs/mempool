...
#[case::tx_version_below_minimal(
    TransactionValidatorConfig {
        ...
        current_tx_version: TransactionVersion::THREE,
        ..Default::default()
    },
...
#[case::tx_version_above_maximal(
    TransactionValidatorConfig {
        ...
        current_tx_version: TransactionVersion::ONE,
        ..Default::default()
    },
    Transaction::Invoke(InvokeTransaction::V1(InvokeTransactionV1 {..Default::default()})),
    TransactionValidatorError::InvalidTransactionVersion(
...
#[case::tx_version_above_current(
    TransactionValidatorConfig {
        min_allowed_tx_version: TransactionVersion::ZERO,
        max_allowed_tx_version: TransactionVersion::ZERO,
        current_tx_version: TransactionVersion::ZERO,
        ..Default::default()
    },
    Transaction::Invoke(InvokeTransaction::V1(InvokeTransactionV1 {..Default::default()})),
    TransactionValidatorError::InvalidTransactionVersion(
        TransactionVersion::ONE,
        format!{"Maximal valid version is {:?}.", TransactionVersion::ZERO}
    )
)]
