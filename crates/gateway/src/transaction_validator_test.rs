...
use starknet_api::transaction::{
    ...
    ResourceBounds, ResourceBoundsMapping, Transaction, TransactionVersion,
};

use crate::starknet_api_utils::TransactionParametersExt;
...
#[case::valid_deploy_account_tx(
    VALIDATOR_CONFIG_FOR_TESTING,
    Transaction::DeployAccount(DeployAccountTransaction::create_for_testing(Some(
        ResourceBoundsMapping::try_from(vec![
            (
                starknet_api::transaction::Resource::L1Gas,
                ResourceBounds{max_amount: 1, max_price_per_unit: 1 }
...
#[case::valid_invoke_tx(
    ...
    Transaction::Invoke(InvokeTransaction::create_for_testing(Some(
        ResourceBoundsMapping::try_from(vec![
            (
                starknet_api::transaction::Resource::L1Gas,
                ResourceBounds{max_amount: 1, max_price_per_unit: 1 }
