...
impl StatelessTransactionValidator {
    ...
    fn validate_sierra_version(
        ...
        if less_then_version_id(sierra_version, MIN_SIERRA_VERSION) {
            return Err(StatelessTransactionValidatorError::SierraVersionOutOfRange {
...
fn sierra_version_from_sierra_program(
    ...
    if len_of_sierra_program < 3 {
        ...
        return Err(StatelessTransactionValidatorError::SierraProgramTooShort {
    ...
    let map_err =
        || StatelessTransactionValidatorError::InvalidSierraVersion { version: version_as_felts };
    Ok(VersionId {
