...
impl StatelessTransactionValidator {
    ...
    fn validate_resource_bounds(&self, tx: &ExternalTransaction) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_tx_size(&self, tx: &ExternalTransaction) -> StatelessTransactionValidatorResult<()> {
