...
pub fn external_tx_for_testing(
    ...
    let version = version.unwrap_or(TransactionVersion::THREE);
    match transaction_type {
        ...
        TransactionType::DeployAccount => external_deploy_account_tx(
            deploy_account_tx_args!(version, resource_bounds, constructor_calldata: calldata, signature),
        ),
...
pub fn external_tx_to_json(tx: ExternalTransaction, type_string: &str) -> String {
    // Serialize to JSON
