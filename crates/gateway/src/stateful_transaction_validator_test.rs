...
use test_utils::starknet_api_test_utils::TEST_SENDER_ADDRESS;
...
fn state_reader_factory_account_nonce_1(sender_address: ContractAddress) -> TestStateReaderFactory {
    ...
    state_reader_factory.state_reader.blockifier_state_reader.address_to_nonce.insert(sender_address, Nonce(StarkFelt::ONE));
