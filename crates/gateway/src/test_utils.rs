...
use starknet_api::transaction::{DeclareTransactionV0V1, Fee, Transaction, TransactionSignature};
...
pub fn create_transaction(declare_type: DeclareTransaction) -> Transaction {
    Transaction::Declare(declare_type)
}
