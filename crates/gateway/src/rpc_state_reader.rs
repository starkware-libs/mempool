...
use crate::rpc_objects::{
    BlockId, BlockTag, GetClassHashAtParams, GetNonceParams, GetStorageAtParams, RpcResponse,
...
impl StateReader for RpcStateReader {
    ...
    fn get_class_hash_at(&self, contract_address: ContractAddress) -> StateResult<ClassHash> {
        ...
        let result =
            self.send_rpc_request("starknet_getClassHashAt", json!(get_class_hash_at_params))?;
