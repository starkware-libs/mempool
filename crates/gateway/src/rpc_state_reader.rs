...
impl RpcReader {
    ...
    pub fn get_latest_block_info(&self) -> Result<BlockInfo, StateError> {
        ...
        let request_body = json!({
            ...
            "params": json!(get_block_params),
        });

        let block: BlockWithTxHashes = serde_json::from_value(self.send_rpc_request(request_body)?)
            .map_err(|e| {
