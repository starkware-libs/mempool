...
use starknet_mempool_types::mempool_types::{Account, MempoolInput, MempoolInvocation};
...
pub struct AppState {
    ...
    pub mempool: Arc<Box<dyn MempoolInvocation>>,
}
...
impl Gateway {
    pub fn new(
        ...
        mempool: Box<dyn MempoolInvocation>,
    ) -> Self {
