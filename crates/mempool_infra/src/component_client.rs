...
pub struct ComponentClientChannel<Request, Response>
where
    Request: Send + Sync,
    Response: Send + Sync,
{
...
impl<Request, Response> ComponentClientChannel<Request, Response>
where
    Request: Send + Sync,
    Response: Send + Sync,
{
...
impl<Request, Response> Clone for ComponentClientChannel<Request, Response>
where
    Request: Send + Sync,
    Response: Send + Sync,
{
...
impl<Component> ComponentClientHttp<Component> {
        ...
        Response: for<'a> Deserialize<'a>,
    {
        ...
        Ok(bincode::deserialize(&body_bytes).expect("Response deserialization should succeed"))
    }
}
