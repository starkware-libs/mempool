...
impl RemoteA for ComponentA {
    async fn a_get_value(
        ...
        Ok(Response::new(AGetValueReturnMessage {
            value: ComponentATrait::a_get_value(self).await,
        }))
    }
}
...
impl RemoteB for ComponentB {
    async fn b_get_value(
        ...
        Ok(Response::new(BGetValueReturnMessage {
            value: ComponentBTrait::b_get_value(self).await.into(),
        }))
    }
}
