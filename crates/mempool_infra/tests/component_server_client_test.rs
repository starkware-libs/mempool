...
use starknet_mempool_infra::component_client::ComponentClientChannel;
...
#[async_trait]
impl ComponentAClientTrait for ComponentClientChannel<ComponentARequest, ComponentAResponse> {
...
#[async_trait]
impl ComponentBClientTrait for ComponentClientChannel<ComponentBRequest, ComponentBResponse> {
...
async fn test_setup() {
    ...
    let a_client = ComponentClientChannel::new(tx_a.clone());
    let b_client = ComponentClientChannel::new(tx_b.clone());
