mod tests {
    ...
    #[tokio::test]
    async fn test_direct_mempool_simple_add_transaction() {
        test_mempool_simple_add_transaction(Mempool::default()).await;
    }

    #[tokio::test]
    async fn test_proxy_mempool_simple_add_transaction() {
        test_mempool_simple_add_transaction(MempoolProxy::default()).await;
    }
